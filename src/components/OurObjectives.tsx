...
const features: Feature[] = [
  ...
  {
    name: 'Assistance',
    description: 'Assist the Ministry of Public Health of Cameroon in financing the functioning of health services.',
  },
  {
    name: 'Donations',
  ...
  },
  {
    ...
    description: 'Contribute to the reinforcement of the health system within the Region to assure quality of health services.',
  },
  {
    name: 'Resourcefulness',
    description: 'Set up resource generating entities strictly in the health domain to reinforce the health system.',
  },
  {
    name: 'Promotions',
    description: 'Strengthen health promotion, rehabilitative and preventive activities in the Region.',
  },
  {
    name: 'Community',
    description: 'Ensure effective community participation in health activities in the Region.',
  },
  {
    name: 'Capacity building',
    description: 'Support capacity building of health personnel and dialogue structures.',
  },
]
          ...
          <div className="mt-12 lg:mt-0 lg:col-span-2">
            <dl className="space-y-10 sm:space-y-0 sm:grid sm:grid-cols-2 sm:grid-rows-4 sm:grid-flow-col sm:gap-x-6 sm:gap-y-10 lg:gap-x-8">
              {features.map((feature, index) => (
                <Reveal key={feature.name} direction="up" delay={index * 100}>
